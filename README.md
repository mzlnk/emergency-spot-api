...
The other part of the project is user interface (Android app) which connects to the REST API and provides data manipulation support. Link to the repository: https://github.com/macko99/androidMapApp
